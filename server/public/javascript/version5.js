  ...
  createUser() {
    ...
    fetch(createRoute, { 
      ...
      if(data) {
        ...
        setTimeout(()=>this.setState({createMessage:""}), 1000);
      }
    });
  }
}
...
class TaskListComponent extends React.Component {
  ...
  render() {
    return ce('div', null, 
      ...
      ce('br'),
      ce('ul', null,
        this.state.tasks.map(taskData => ce('li', { key: taskData.id, onClick: e => this.handleDeleteClick(taskData.id) }, taskData.text))
      ),
      ce('br'),
      ce('div', null,
